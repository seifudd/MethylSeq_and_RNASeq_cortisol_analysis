...
pheno = read.table(file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/bedtime_cortisol_high_low.txt", header=T, row.names=1)
load("/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/00-runSVA/RL_bedtime_cortisol_filtered_10.32.cpgs.M.granges.without.SNPs.svaobj.Rdata")
pheno_mat = model.matrix(~pheno[,"dx"] + RL_bedtime_cortisol_filtered_10.32.cpgs.M.granges.without.SNPs.svaobj$sv)
...
gc()
write.table(RL_chr1.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr1/bedtime_cortisol_high_low_chr1_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr1_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr1.bumps$coef, coefficients_smooth=RL_chr1.bumps$fitted, pvaluesMarginal=RL_chr1.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr1_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr1/bedtime_cortisol_high_low_chr1_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr2.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr2/bedtime_cortisol_high_low_chr2_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr2_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr2.bumps$coef, coefficients_smooth=RL_chr2.bumps$fitted, pvaluesMarginal=RL_chr2.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr2_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr2/bedtime_cortisol_high_low_chr2_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr3.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr3/bedtime_cortisol_high_low_chr3_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr3_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr3.bumps$coef, coefficients_smooth=RL_chr3.bumps$fitted, pvaluesMarginal=RL_chr3.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr3_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr3/bedtime_cortisol_high_low_chr3_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr4.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr4/bedtime_cortisol_high_low_chr4_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr4_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr4.bumps$coef, coefficients_smooth=RL_chr4.bumps$fitted, pvaluesMarginal=RL_chr4.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr4_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr4/bedtime_cortisol_high_low_chr4_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr5.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr5/bedtime_cortisol_high_low_chr5_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr5_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr5.bumps$coef, coefficients_smooth=RL_chr5.bumps$fitted, pvaluesMarginal=RL_chr5.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr5_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr5/bedtime_cortisol_high_low_chr5_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr6.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr6/bedtime_cortisol_high_low_chr6_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr6_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr6.bumps$coef, coefficients_smooth=RL_chr6.bumps$fitted, pvaluesMarginal=RL_chr6.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr6_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr6/bedtime_cortisol_high_low_chr6_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr7.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr7/bedtime_cortisol_high_low_chr7_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr7_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr7.bumps$coef, coefficients_smooth=RL_chr7.bumps$fitted, pvaluesMarginal=RL_chr7.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr7_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr7/bedtime_cortisol_high_low_chr7_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr8.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr8/bedtime_cortisol_high_low_chr8_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr8_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr8.bumps$coef, coefficients_smooth=RL_chr8.bumps$fitted, pvaluesMarginal=RL_chr8.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr8_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr8/bedtime_cortisol_high_low_chr8_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr9.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr9/bedtime_cortisol_high_low_chr9_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr9_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr9.bumps$coef, coefficients_smooth=RL_chr9.bumps$fitted, pvaluesMarginal=RL_chr9.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr9_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr9/bedtime_cortisol_high_low_chr9_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr10.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr10/bedtime_cortisol_high_low_chr10_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr10_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr10.bumps$coef, coefficients_smooth=RL_chr10.bumps$fitted, pvaluesMarginal=RL_chr10.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr10_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr10/bedtime_cortisol_high_low_chr10_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr11.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr11/bedtime_cortisol_high_low_chr11_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr11_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr11.bumps$coef, coefficients_smooth=RL_chr11.bumps$fitted, pvaluesMarginal=RL_chr11.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr11_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr11/bedtime_cortisol_high_low_chr11_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr12.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr12/bedtime_cortisol_high_low_chr12_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr12_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr12.bumps$coef, coefficients_smooth=RL_chr12.bumps$fitted, pvaluesMarginal=RL_chr12.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr12_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr12/bedtime_cortisol_high_low_chr12_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr13.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr13/bedtime_cortisol_high_low_chr13_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr13_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr13.bumps$coef, coefficients_smooth=RL_chr13.bumps$fitted, pvaluesMarginal=RL_chr13.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr13_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr13/bedtime_cortisol_high_low_chr13_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr14.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr14/bedtime_cortisol_high_low_chr14_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr14_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr14.bumps$coef, coefficients_smooth=RL_chr14.bumps$fitted, pvaluesMarginal=RL_chr14.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr14_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr14/bedtime_cortisol_high_low_chr14_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr15.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr15/bedtime_cortisol_high_low_chr15_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr15_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr15.bumps$coef, coefficients_smooth=RL_chr15.bumps$fitted, pvaluesMarginal=RL_chr15.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr15_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr15/bedtime_cortisol_high_low_chr15_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr16.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr16/bedtime_cortisol_high_low_chr16_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr16_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr16.bumps$coef, coefficients_smooth=RL_chr16.bumps$fitted, pvaluesMarginal=RL_chr16.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr16_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr16/bedtime_cortisol_high_low_chr16_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr17.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr17/bedtime_cortisol_high_low_chr17_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr17_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr17.bumps$coef, coefficients_smooth=RL_chr17.bumps$fitted, pvaluesMarginal=RL_chr17.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr17_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr17/bedtime_cortisol_high_low_chr17_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr18.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr18/bedtime_cortisol_high_low_chr18_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr18_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr18.bumps$coef, coefficients_smooth=RL_chr18.bumps$fitted, pvaluesMarginal=RL_chr18.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr18_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr18/bedtime_cortisol_high_low_chr18_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr19.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr19/bedtime_cortisol_high_low_chr19_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr19_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr19.bumps$coef, coefficients_smooth=RL_chr19.bumps$fitted, pvaluesMarginal=RL_chr19.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr19_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr19/bedtime_cortisol_high_low_chr19_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr20.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr20/bedtime_cortisol_high_low_chr20_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr20_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr20.bumps$coef, coefficients_smooth=RL_chr20.bumps$fitted, pvaluesMarginal=RL_chr20.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr20_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr20/bedtime_cortisol_high_low_chr20_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr21.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr21/bedtime_cortisol_high_low_chr21_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr21_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr21.bumps$coef, coefficients_smooth=RL_chr21.bumps$fitted, pvaluesMarginal=RL_chr21.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr21_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr21/bedtime_cortisol_high_low_chr21_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chr22.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr22/bedtime_cortisol_high_low_chr22_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chr22_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chr22.bumps$coef, coefficients_smooth=RL_chr22.bumps$fitted, pvaluesMarginal=RL_chr22.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chr22_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chr22/bedtime_cortisol_high_low_chr22_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chrX.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chrX/bedtime_cortisol_high_low_chrX_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chrX_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chrX.bumps$coef, coefficients_smooth=RL_chrX.bumps$fitted, pvaluesMarginal=RL_chrX.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chrX_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chrX/bedtime_cortisol_high_low_chrX_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
...
gc()
write.table(RL_chrY.bumps$table, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chrY/bedtime_cortisol_high_low_chrY_bumps_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
bedtime_cortisol_high_low_chrY_bumps_coef_pvaluesMarginal_smoothcoef = data.frame(cbind(coefficients=RL_chrY.bumps$coef, coefficients_smooth=RL_chrY.bumps$fitted, pvaluesMarginal=RL_chrY.bumps$pvaluesMarginal))
write.table(bedtime_cortisol_high_low_chrY_bumps_coef_pvaluesMarginal_smoothcoef, file="/home/cluster/nas1/fseifudd/02-methylseq/13-gary-methylseq-human/15-run_bumphunter/chrY/bedtime_cortisol_high_low_chrY_bumps_coef_pvaluesMarginal_smoothcoef_1000.bootstraps_maxgap_300.NOloessbyClustersmoothing.with.covariates.sva.without.snps.zero.constant.added.txt")
