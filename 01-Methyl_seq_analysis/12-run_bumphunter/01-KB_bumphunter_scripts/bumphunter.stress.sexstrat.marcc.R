...
out.values=c(pheno1$meanNEstress,pheno2$meanNEstress)
...
setwd("/data/NHLBI_BCB/Fayaz/19-rales12-bumphunter-results-dichot")
write.table(boy.bump$table, file="rales12.bump.stress.boy.txt")
boy.bump.pvaluesMarginal = data.frame(cbind(beta=boy.bump$coef, pvaluesMarginal=boy.bump$pvaluesMarginal))
write.table(boy.bump.pvaluesMarginal, file="rales12.bump.pvalues.stress.boy.txt")
...
setwd("/data/NHLBI_BCB/Fayaz/19-rales12-bumphunter-results-dichot")
write.table(girl.bump$table, file="rales12.bump.stress.girl.txt")
girl.bump.pvaluesMarginal = data.frame(cbind(beta=girl.bump$coef, pvaluesMarginal=girl.bump$pvaluesMarginal))
write.table(girl.bump.pvaluesMarginal, file="rales12.bump.pvalues.stress.girl.txt")
