...
out=c(pheno1$meanNEstress,pheno2$meanNEstress)
...
setwd("/data/NHLBI_BCB/Fayaz/18-rales12-bumphunter-results")
write.table(r12.bump$table, file="rales12.bump.stress.txt")
rales12.bump.pvaluesMarginal = data.frame(cbind(beta=r12.bump$coef, pvaluesMarginal=r12.bump$pvaluesMarginal))
write.table(rales12.bump.pvaluesMarginal, file="rales12.bump.pvalues.stress.txt")
